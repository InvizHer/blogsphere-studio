...
export const themePresets: ThemePreset[] = [
  ...
  },
  {
    ...
    name: "Lavender → Blush",
    type: "gradient",
    preview: "linear-gradient(135deg, hsl(295,30%,78%), hsl(290,28%,72%))",
    vars: {
      "--primary": "295 30% 68%",
      "--accent": "290 28% 72%",
      "--ring": "295 30% 68%",
      "--primary-dark": "295 30% 74%",
      "--accent-dark": "290 28% 76%",
      "--ring-dark": "295 30% 74%",
      "--gradient-primary": "linear-gradient(135deg, hsl(295,30%,78%), hsl(290,28%,72%))",
      "--gradient-hero": "linear-gradient(160deg, hsl(295,20%,6%) 0%, hsl(295,30%,14%) 40%, hsl(290,25%,20%) 100%)",
      "--gradient-subtle": "linear-gradient(135deg, hsl(295,30%,68%/0.08), hsl(290,28%,72%/0.08))",
      "--shadow-elevated": "0 10px 40px -10px hsl(295 30% 68%/0.15), 0 8px 16px -8px hsl(295 20% 8%/0.06)",
      "--shadow-glow": "0 0 40px hsl(295 30% 68%/0.2)",
      "--sidebar-primary": "295 30% 74%",
      "--sidebar-primary-dark": "295 30% 74%",
      "--sidebar-accent-bg": "295 20% 12%",
      "--sidebar-ring": "295 30% 68%",
    },
  },
  {
    id: "fire-blaze",
    name: "Fire Blaze",
    type: "gradient",
    preview: "linear-gradient(135deg, hsl(0,85%,45%), hsl(25,100%,50%), hsl(45,100%,55%))",
    vars: {
      "--primary": "25 100% 50%",
      "--accent": "0 85% 45%",
      "--ring": "25 100% 50%",
      "--primary-dark": "25 100% 56%",
      "--accent-dark": "0 85% 52%",
      "--ring-dark": "25 100% 56%",
      "--gradient-primary": "linear-gradient(135deg, hsl(0,85%,45%), hsl(25,100%,50%), hsl(45,100%,55%))",
      "--gradient-hero": "linear-gradient(160deg, hsl(0,60%,4%) 0%, hsl(15,70%,10%) 40%, hsl(30,80%,14%) 100%)",
      "--gradient-subtle": "linear-gradient(135deg, hsl(25,100%,50%/0.06), hsl(0,85%,45%/0.06))",
      "--shadow-elevated": "0 10px 40px -10px hsl(25 100% 50%/0.18), 0 8px 16px -8px hsl(0 60% 8%/0.08)",
      "--shadow-glow": "0 0 40px hsl(25 100% 50%/0.25)",
      "--sidebar-primary": "25 100% 56%",
      "--sidebar-primary-dark": "25 100% 56%",
      "--sidebar-accent-bg": "0 40% 10%",
