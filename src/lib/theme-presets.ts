...
export const themePresets: ThemePreset[] = [
  ...
  },
  {
    ...
    name: "Lavender → Blush",
    type: "gradient",
    preview: "linear-gradient(135deg, hsl(295,30%,78%), hsl(300,40%,90%))",
    vars: {
      "--primary": "295 30% 68%",
      "--accent": "300 40% 80%",
      "--ring": "295 30% 68%",
      "--primary-dark": "295 30% 74%",
      "--accent-dark": "300 40% 84%",
      "--ring-dark": "295 30% 74%",
      "--gradient-primary": "linear-gradient(135deg, hsl(295,30%,78%), hsl(300,40%,90%), hsl(300,50%,96%))",
      "--gradient-hero": "linear-gradient(160deg, hsl(295,20%,6%) 0%, hsl(295,30%,14%) 40%, hsl(300,25%,20%) 100%)",
      "--gradient-subtle": "linear-gradient(135deg, hsl(295,30%,78%/0.08), hsl(300,40%,90%/0.08))",
      "--shadow-elevated": "0 10px 40px -10px hsl(295 30% 68%/0.15), 0 8px 16px -8px hsl(295 20% 8%/0.06)",
      "--shadow-glow": "0 0 40px hsl(295 30% 78%/0.2)",
